        ...
        <div class="row">
            ...
            <h4 class="mb-4 pb-lg-2">Please join us!</h4>
                <form enctype="multipart/form-data" action="{{route('member.store')}}" method="post" class="custom-form membership-form shadow-lg" role="form">
                    ...
                    @if (session('success'))
                     <a class="alert alert-success text-center">{{session('success')}}</a>
                    @endif
                        <div class="form-floating">
                            <input type="text" name="full_name" id="full_name" class="form-control @error('full_name') is-invalid @enderror" placeholder="Full Name" >
                       ...
                       @enderror
                        ...
                        <div class="form-floating">
                            <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control @error('email') is-invalid @enderror" placeholder="Email address">
                       ...
                       @enderror
                        ...
                        <div class="form-floating">
                            <textarea class="form-control @error('message') is-invalid @enderror" id="message" name="message" placeholder="Describe message here"></textarea>
